...
@misc{siqueira_rodrigues_data_2023,
	title = {Data from a {Delayed}-{Match}-to-{Sample} {Task} {Comparing} the {Effects} of {Visual}, {Haptic}, and {Visuohaptic} {Encoding} on {Error} {Rate} and {Response} {Time} in {Virtual} {Reality}},
	url = {https://github.com/lsrodri/MatchToSampleAnalysis},
	publisher = {https://github.com/lsrodri/MatchToSampleAnalysis},
